...
import com.grpc.demo.server.service.AuthorService;
...
public class ServerMain
{
    public static void main( String[] args ) throws Exception {
        ...
        Server server = ServerBuilder.forPort(9090).addService(new BookService()).addService(new AuthorService()).build();
        server.start();
